...
class WideResNetLN(nn.Module):
    def __init__(self, depth, num_classes, widen_factor=1, dropRate=0.0):
        super(WideResNetLN, self).__init__()
        ...
        self.bn1 = LayerNorm2d(nChannels[3])
...
def wrn28_10_ln(num_classes=100):
    return WideResNetLN(depth=28, widen_factor=10, num_classes=num_classes)
